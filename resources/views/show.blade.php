            ...
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="mx-4 w-full">
                    ...
                    <div class="text-gray-600 mt-3 ">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, asperiores, consequuntur
                        cupiditate doloribus expedita explicabo facere fuga illum inventore laboriosam libero modi nam
                        nemo nulla officiis quas qui quidem quisquam ratione sapiente sed sequi sit tenetur totam ut,
                        veritatis vitae.
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            <button
                                ...
                                <ul
                                    x-cloak
                                    x-show.transition.origin="isOpen"
        ...
        <div class="flex items-center space-x-4 ml-6">
            ...
            <div
                ...
                <button
                    @click="isOpen = !isOpen"
                    type="button"
                    class="flex items-center justify-center w-32 h-11 text-sm bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover text-white transition duration-150 ease-in px-6 py-3"
                >
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class=" absolute z-10 w-104 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mmt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button
                                type="button"
                                class="flex items-center justify-center w-1/2 h-11 text-sm bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover text-white transition duration-150 ease-in px-6 py-3"
                            >
            ...
            <div
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class=" absolute z-20 w-76 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mmt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button
                                type="submit"
                                class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover text-white transition duration-150 ease-in px-6 py-3"
                            >
